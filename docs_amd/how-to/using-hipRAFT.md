...
under the `hipRaft/examples` folder. Both C++ and Python examples are provided. These
...
Make sure to link against the appropriate CMake targets. Use `raft::raft` to make the headers
